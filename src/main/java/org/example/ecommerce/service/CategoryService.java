...
public class CategoryService {
    ...
    public boolean isCategoryOrSubcategory(Integer parentId, String childCategoryName) {
        Category parent = categoryRepository.findById(parentId).orElse(null);
        if (parent == null) {
            return false;
        }
        
        Category child = categoryRepository.findByCategoryname(childCategoryName).orElse(null);
        if (child == null) {
            return false;
        }
