...
//        if (freeship != null) oi.setPromotionid(freeship);
//        if (discount != null) oi.setPromotionid(discount);
//        orderItemsRepository.save(oi);
//
...
//        inventory.setSolditems(Optional.ofNullable(inventory.getSolditems()).orElse(0) + quantity);
//        inventoryRepository.save(inventory);
//
//        return "Thanh toán thành công";
//    }
...
//            dto.setColor(ci.getInventoryid().getColor());
//            dto.setDimension(ci.getInventoryid().getDimension());
